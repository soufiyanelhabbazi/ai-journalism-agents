...
ATTRIBUTION_PATTERNS = re.compile(
    ...
    r'|أفاد|أفادت|أكد|أكدت|ذكر|ذكرت|أعلن|أعلنت|كشف|كشفت|أخبر|أخبرت|أبلغ|أبلغت)\b'
    r'|\b(?:حسب|بحسب|وفق|وفقا|وفقاً|حسبما|بيان|تصريح|تصريحات|متحدث|متحدثة|الناطق|الناطقة)\b'
    r'|["«“][^"»”]{15,}["»”]',
    re.IGNORECASE,
)
